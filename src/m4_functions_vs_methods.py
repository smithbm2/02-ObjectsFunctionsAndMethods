...
def try_methods_and_functions():
    ...
    boris.pen = rg.Pen('blue',5)
    boris.backward(150)
    boris.speed = 1
    draw_many_squares(boris,2,100,30)
    boris.speed = 5
    boris.pen = rg.Pen('red',5)
    draw_many_squares(boris,10,50,15)
    boris.speed = 100
    boris.pen = rg.Pen('red',35)
    draw_many_squares(boris,8,300,60)
    boris.pen = rg.Pen('black',3)
    boris.backward(200)
    boris.draw_circle(30)
    draw_many_squares(boris,1,50,0)
